...
from .views import EmployeeCreate, EmployeeUpdate, EmployeeList
...
urlpatterns = [
    ...
    path('employee/<int:pk>/delete', EmployeeList.as_view(), name='employee-delete'),
    path('attendance', EmployeeList.as_view(), name='attendance'),
]
