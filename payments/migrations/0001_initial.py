    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_no', models.CharField(default=payments.models.increment_payment_number, max_length=50, unique=True)),
                ...
                ('payment_from_account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.Accounts')),
