...
from .views import (
    ...
    processing_stock_mess_creation, load_processing_stock, processing_stock_update, processing_complete,
...
urlpatterns = [
    ...
    path('complete_processing/<int:pk>', processing_complete, name='complete-processing'),
